...
factory_type_information = (
    {'id': 'Calendar',
     ...
     'actions': ({'id': 'view',
                 ...
                 {'id': 'month_view',
                  'name': 'cpscalendar_action_month_view',
                 ...
                 {'id': 'week_view',
                  'name': 'cpscalendar_action_week_view',
                 ...
                 {'id': 'day_view',
                  'name': 'cpscalendar_action_day_view',
                 ...
                 {'id': 'addevent',
                  'name': 'cpscalendar_action_addevent',
                 ...
                 {'id': 'meeting',
                  'name': 'cpscalendar_action_addmeeting',
                 ...
                 {'id': 'display',
                  'name': 'cpscalendar_action_display',
                 ...
                 {'id': 'export',
                  'name': 'cpscalendar_action_export',

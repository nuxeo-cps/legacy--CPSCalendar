...
factory_type_information = (
    {'id': 'Event',
     ...
     'actions': ({'id': 'view',
                  'name': '_action_view_',
                  'action': 'string:calendar_event_view',
                  'condition': '',
                  'permissions': (View,)},
                 {'id': 'edit',
                  'name': '_action_modify_',
                  'action': 'string:calendar_editevent_form',
                  'condition': '',
                  'permissions': (ModifyPortalContent,)},
                 {'id': 'attendees',
                  'name': '_action_attendees_',
                  'action': 'string:calendar_attendees_form',
                  'permissions': (ModifyPortalContent,)},
                 {'id': 'delete',
                  'name': '_action_delete_',
                  'action': 'string:calendar_delevent',
                  'condition': '',
                  'permissions': (ModifyPortalContent,)},
                 {'id': 'calendar',
                  'name': '_action_calendar_',
                  'action': 'string:../',
                  'permissions': (View,)},
                 {'id': 'create',
                  'name': '_action_create_',
                  'action': 'string:calendar_eventcreate_form',
                  'condition': '',
                  'visible': 0,
                  'permissions': ()},
                )
